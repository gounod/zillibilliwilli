...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { description: @discussion.description, state: @discussion.state, title: @discussion.title, user: @discussion.user }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { description: @discussion.description, state: @discussion.state, title: @discussion.title, user: @discussion.user }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
